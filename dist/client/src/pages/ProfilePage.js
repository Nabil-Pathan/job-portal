...
const ProfilePage = ({ open }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsxs)("div", { className: "container mx-auto p-4", children: [(0, jsx_runtime_1.jsx)("div", { className: "flex justify-end px-4 gap-4 ", children: (0, jsx_runtime_1.jsx)(DropDown_1.default, { open: open }) }), (0, jsx_runtime_1.jsxs)("form", { onSubmit: handleSubmit, children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex md:flex-row flex-col ", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex-1 flex justify-center  p-4", children: [(0, jsx_runtime_1.jsx)("img", { onClick: () => fileRef.current && fileRef.current.click(), className: "md:h-[400px] cursor-pointer", src: (user === null || user === void 0 ? void 0 : user.pic) || formData.pic, alt: "" }), fileError && (0, jsx_runtime_1.jsx)("p", { className: "text-red-500 mt-4" }), fileUploading && (0, jsx_runtime_1.jsx)("p", {}), (0, jsx_runtime_1.jsx)("input", { onChange: handleFileChange, type: "file", ref: fileRef, hidden: true, accept: 'image/*' })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex-1 md:p-6", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("label", { htmlFor: "name", className: "block  font-medium text-gray-700", children: "Name" }), (0, jsx_runtime_1.jsx)("input", { type: "text", id: "name", name: "name", className: "mt-1 block w-full border border-gray-300 px-4 py-3 outline-none rounded-md shadow-sm", placeholder: "Your Full Name", value: formData.name, onChange: handleChange })] }), (0, jsx_runtime_1.jsxs)("div", { className: "mt-4", children: [(0, jsx_runtime_1.jsx)("label", { htmlFor: "name", className: "block  font-medium text-gray-700", children: "Email" }), (0, jsx_runtime_1.jsx)("input", { type: "email", id: "email", name: "email", className: "mt-1 block w-full border border-gray-300 px-4 py-3 outline-none rounded-md shadow-sm ", placeholder: "Your Full Name", value: formData.email, onChange: handleChange })] }), (0, jsx_runtime_1.jsxs)("div", { className: "mt-4", children: [(0, jsx_runtime_1.jsx)("label", { htmlFor: "name", className: "block  font-medium text-gray-700", children: "Password" }), (0, jsx_runtime_1.jsx)("input", { type: "password", id: "password", name: "password", className: "mt-1 block w-full border border-gray-300 px-4 py-3 outline-none rounded-md shadow-sm ", placeholder: "Change Password", onChange: handleChange })] }), (0, jsx_runtime_1.jsx)("button", { type: "submit", className: " mt-6 bg-blue-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline hover:bg-blue-600", children: "Update" })] })] }), filePer && (0, jsx_runtime_1.jsx)("p", { className: "text-center" })] })] }) }));
};
