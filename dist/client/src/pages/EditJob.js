...
const EditJob = () => {
    ...
    const handleSubmit = (e) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const { data } = yield axios_1.default.put(`/api/job/update-job/${params.jobId}`, { title, description, company, salary, location, requirements }, config);
            console.log(data);
            react_hot_toast_1.default.success("Job Updated");
            navigate('/jobs');
        }
        catch (error) {
